"""Control Tower API routes for overview, health, anomalies, corridors, map flows."""
...
def get_live_payments(limit: int = Query(20, ge=1, le=100)):
    """Get the most recent in-progress/delayed payments."""
...
def get_corridors():
    return metrics_service.get_corridors()
